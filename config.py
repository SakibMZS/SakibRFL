...
# =========================================================
# CENTRAL MACHINE MASTER REGISTRY (61 Total Machines)
# =========================================================
MACHINE_MASTER = [
    # --- FIRST FLOOR (FF) (25 Machines) ---
...
EXCEL_SIZES = [
    "160", "90", "120", "250", "270", "280", "380", "330", "470", "530", "800", "428"
]
SORTED_SIZES = sorted(EXCEL_SIZES, key=len, reverse=True)


def get_size_from_position(pos_str):
